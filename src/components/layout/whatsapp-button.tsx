...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="sticker-shadow fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full border-[2.5px] border-ink bg-[#25D366] text-white transition-all hover:-translate-y-0.5 hover:shadow-[4px_4px_0_0_var(--color-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
    >
